...
const primaryIcons: SocialLink[] = [
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/GroundNarrative',
    icon: (
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/groundnarrative/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@TheGroundNarrative',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const extraIcons: SocialLink[] = [
  {
    name: 'X',
    url: 'https://x.com/GroundNarrative',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
